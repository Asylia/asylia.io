<template>
  <div
    ...
    @click="openGitCommit"
  >
    <span class="bg-emerald-600 bg-white rounded-full w-3 h-3" />
...
const hasGitCommitHash = props.gitCommitHash.toString().length > 0;

const openGitCommit = () => {
  window.open('https://github.com/Asylia/asylia.io/commit/' + props.gitCommitHash, '_blank');
};
</script>
